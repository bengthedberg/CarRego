...
namespace CarRego.Domain.UnitTests.Extensions;
...
public static class DBCommandExtensions
{
    ...
    {
        cmd.CommandText = "SET IDENTITY_INSERT People ON; SET DATEFORMAT dmy;  " +
    ...
    {
        cmd.CommandText = "SET IDENTITY_INSERT Vehicles ON; SET DATEFORMAT dmy; " +
